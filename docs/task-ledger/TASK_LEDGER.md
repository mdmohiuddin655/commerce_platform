...
| Dispute resolution | How a fallback dispute resolves, and any delivery/refusal/return/money consequence | **NOT STARTED / DEFERRED** — enumerated and refused by FND-003D2B; needs **O6** and FND-003C. FND-003B3B is now accepted and integrated and defines the refused-order return, but decides **no** dispute outcome, fault or money |
