...
| FND-003C money | Payment/COD, cash journal, fees, refusal policy, commissions, settlement | **PARTIAL** — **O6 resolved** by ADR-0011; FND-003C1 delivers the COD collection and cash-journal foundation (local candidate, not yet published); remittance, settlement, reconciliation, refusal-fee collection, refunds, compensation, commission payout and worker pay remain **unimplemented** |
